...
import { ObservationCondidatesService } from './observation-condidates.service';
import { Table } from 'primeng/table';

@Component({
  selector: 'app-observation-condidates',
  templateUrl: './observation-condidates.component.html',
  styleUrls: ['./observation-condidates.component.css']
})
export class ObservationCondidatesComponent implements OnInit{
  ...
  constructor(
    private ccdService: ObservationCondidatesService,
