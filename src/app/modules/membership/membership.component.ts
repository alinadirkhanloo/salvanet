...
export class MembershipComponent implements OnInit{
  ...
  dataSource: IMembership[]=[];
  selectedList: IMembership[]=[];
  ...
  constructor(
    ...
    private productService:MembershipService,
  ...
  openProductForm(){
    let modalRef = this.modalService.open(MembershipEditComponent);
  ...
  openProductEditForm(product:IMembership){
    let modalRef = this.modalService.open(MembershipEditComponent);
  }
