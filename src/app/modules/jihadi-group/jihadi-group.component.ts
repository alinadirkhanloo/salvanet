...
@Component({
  selector: 'app-jihadi-group',
  templateUrl: './jihadi-group.component.html',
  styleUrls: ['./jihadi-group.component.css']
})
export class JihadiGroupComponent implements OnInit {
