...
import { NaturalPersonsService } from './natural-person.service';
...
export class NaturalPersonsComponent  implements OnInit {
  ...
  constructor(
    ...
    private personService:NaturalPersonsService
    ) {}
